...
class body_state_t(object):
    __slots__ = ["p", "vWorld", "vBody", "rpy", "omegaBody", "omegaWorld", "quat", "contact_estimate", "aBody", "aWorld", "timestamp_ms", "robot_id"]

    __typenames__ = ["float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "int64_t", "int64_t"]

    __dimensions__ = [[3], [3], [3], [3], [3], [3], [4], [4], [3], [3], None, None]
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(body_state_t._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != body_state_t._get_packed_fingerprint():
            raise ValueError("Decode error")
        return body_state_t._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        if body_state_t in parents: return 0
        tmphash = (0x9c3b951fa2d245ea) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if body_state_t._packed_fingerprint is None:
            body_state_t._packed_fingerprint = struct.pack(">Q", body_state_t._get_hash_recursive([]))
        return body_state_t._packed_fingerprint
    _get_packed_fingerprint = staticmethod(_get_packed_fingerprint)

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", body_state_t._get_packed_fingerprint())[0]
